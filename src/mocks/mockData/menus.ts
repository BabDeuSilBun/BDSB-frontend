...
export const menus: { [storeId: number]: MenuType[] } = {
  // Menus for storeId 1
  1: [
    {
      menuId: 1,
...
Object.keys(menus).forEach((storeId) => {
  const storeMenus = menus[Number(storeId)];
